...
The following applies to code changes to the Searchcoin Core project, and is not to be
confused with overall Searchcoin Network Protocol consensus changes.
