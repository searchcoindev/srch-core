...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/searchcoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/searchcoin-cli.cpp \
           src/searchcoin-tx.cpp \
           src/searchcoin.cpp \
           src/db.cpp \
           ...
           src/qt/searchcoin.cpp \
           src/qt/searchcoinstrings.cpp \
...
RESOURCES += src/qt/searchcoin.qrc src/qt/searchcoin_locale.qrc

TRANSLATIONS += src/qt/locale/searchcoin_bg.ts \
                src/qt/locale/searchcoin_de.ts \
                src/qt/locale/searchcoin_en.ts \
                src/qt/locale/searchcoin_es.ts \
                src/qt/locale/searchcoin_fi.ts \
                src/qt/locale/searchcoin_fr.ts \
                src/qt/locale/searchcoin_it.ts \
                src/qt/locale/searchcoin_ja.ts \
                src/qt/locale/searchcoin_pl.ts \
                src/qt/locale/searchcoin_pt.ts \
                src/qt/locale/searchcoin_ru.ts \
                src/qt/locale/searchcoin_sk.ts \
                src/qt/locale/searchcoin_sv.ts \
                src/qt/locale/searchcoin_vi.ts \
                src/qt/locale/searchcoin_zh_CN.ts \
                src/qt/locale/searchcoin_zh_TW.ts
