...
In order to support loading of multiple wallets in searchcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is searchcoin.cpp.
...
Changes to searchcoin.cpp
----------------------
searchcoin.cpp is the entry point into searchcoin-qt, and as such, will require some minor modifications to provide hooks for
