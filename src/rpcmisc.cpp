...
// Copyright (c) 2017-2018 The Searchcoin developers
...
Value getinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total searchcoin balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zSRCHsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zSRCH denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zSRCH denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zSRCH denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zSRCH denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zSRCH denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zSRCH denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zSRCH denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zSRCH denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zSRCH denominations\n"
            "  }\n"
            "  \"keypoololdest\": xxxxxx,    (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,        (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,      (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in searchcoin/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in searchcoin/kb\n"
    ...
    obj.emplace_back(Pair("zSRCHsupply", zcivObj));
...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"searchcoinaddress\"\n"
            "\nReturn information about the given searchcoin address.\n"
            "\nArguments:\n"
            "1. \"searchcoinaddress\"     (string, required) The searchcoin address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"searchcoinaddress\", (string) The searchcoin address validated\n"
...
#ifdef ENABLE_WALLET
        // Case 1: Searchcoin address and we have full public key:
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"searchcoinaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"searchcoinaddress\"  (string, required) The searchcoin address to use for the signature.\n"
