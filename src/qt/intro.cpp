...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Searchcoin Core"),
     ...
     * override -datadir in the searchcoin.conf file in the default data directory
     * (to be consistent with searchcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
