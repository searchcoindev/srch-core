                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Searchcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSRCH"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Searchcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Searchcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Searchcoin"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Searchcoin Core help message to get a list with possible Searchcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Searchcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Searchcoin network", "", count));
}
...
{
    QString strTitle = tr("Searchcoin Core"); // default title
