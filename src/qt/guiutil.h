...
/** Utility functions used by the Searchcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Searchcoin addresses in monospace font
...
// Parse "searchcoin:" URI into recipient object, return true on successful parsing
