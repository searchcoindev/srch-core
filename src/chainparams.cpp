...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000e2c940bfea2b0aea6845397dda767c2cb620b7dca4c8105f6f976cf058c"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1535790476, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("04e5b8a0104740bb3db798d57f6bac9588a4aa4717a238c208edc18bdaa46a233f021b82ed860b602dfc5cc74208d758b21dd8e34ca9446fe76f86498aedc839a2");
        nDefaultPort =  19000;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Searchcoin starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Searchcoin: 1 minute
        nTargetSpacing = 1 * 60;  // Searchcoin: 1 minute
        nMaturity = 10;
        ...
        nZerocoinStartTime = 1565444448;
        nBlockEnforceSerialRange = 1;
        nBlockRecalculateAccumulators = ~1;
        nBlockFirstFraudulent = ~1;
        nBlockLastGoodCheckpoint = ~1;
        const char* pszTimestamp = "Never mind searching for who you are. Search for the person you aspire to be. August 2018";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1535790476;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1828601;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000e2c940bfea2b0aea6845397dda767c2cb620b7dca4c8105f6f976cf058c"));
        assert(genesis.hashMerkleRoot == uint256("0xceb8c8363c2781c3c92c864134c8b3402e251380ecc10658f7929a0ff0ccca96"));

        vSeeds.push_back(CDNSSeedData("80.211.43.93", "80.211.43.93"));
        vSeeds.push_back(CDNSSeedData("80.211.1.5", "80.211.1.5"));
        ...
        strSporkKey = "0429720608C5D4AD7DE6F1EC70869DC023F662A4882B313354DC1B107BA024C39F14DF23DF9053CBB29E0DC2F330507FCF3389F3A7236776BDE8504CA85CAFDA7C";
        strObfuscationPoolDummyAddress = "STHiTqQoKdr9S2c3WoFWS6ZFcQs4TSNUqo";
        nStartMasternodePayments = 1535790476;
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Searchcoin: 1 day
        nTargetSpacing = 1 * 15;  // Searchcoin: 15 seconds
        nLastPOWBlock = 3000;
        nMaturity = 2;
  	...
  	hashGenesisBlock = genesis.GetHash();
        ...
        //Testnet node 1
         vSeeds.push_back(CDNSSeedData("testnet1.searchcoin.org", "45.32.234.179"));
           //Testnet node 2
         vSeeds.push_back(CDNSSeedData("testnet2.searchcoin.org", "209.250.253.166"));        // Single node address
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet searchcoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet searchcoin script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet searchcoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet searchcoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet searchcoin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Searchcoin: 1 day
        nTargetSpacing = 1 * 60;        // Searchcoin: 1 minutes
