...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Searchcoin features */
        {"searchcoin", "masternode", &masternode, true, true, false},
        {"searchcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"searchcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"searchcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"searchcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"searchcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"searchcoin", "startmasternode", &startmasternode, true, true, false},
        {"searchcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"searchcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"searchcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"searchcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"searchcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"searchcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"searchcoin", "mnbudget", &mnbudget, true, true, false},
        {"searchcoin", "preparebudget", &preparebudget, true, true, false},
        {"searchcoin", "submitbudget", &submitbudget, true, true, false},
        {"searchcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"searchcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"searchcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"searchcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"searchcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"searchcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"searchcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"searchcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"searchcoin", "mnsync", &mnsync, true, true, false},
        {"searchcoin", "spork", &spork, true, true, false},
        {"searchcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"searchcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use searchcoind, or the -server option to searchcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1: 19001/\n";
}
